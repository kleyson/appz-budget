...
**Category**: Finance
**Subtitle**: Personal Budget Manager (30 characters max)

---

## Promotional Text

_(170 characters max - appears above the description on the App Store)_
...
_(100 characters max, comma-separated, no spaces after commas)_
...
_(For Apple Review Team - 4000 characters max)_
...
1. The app requires a backend API to function. You can use the demo server at https://budget.appz.wtf/
2. On first launch, you'll need to configure the API endpoint:
   - Go to Settings → API Configuration
   - Enter API URL: `https://budget.appz.wtf`
   - Enter API Key: `your-secret-api-key-change-this` (this is the default demo key)
3. After configuring the API, you can log in with the demo credentials above
4. All features are fully functional with the demo server
...
Complete the age rating questionnaire in App Store Connect. Based on the app's functionality:
...
https://github.com/kleyson/appz-budget/issues

### Marketing URL (Optional)

https://budget.appz.wtf/

### Privacy Policy URL

https://github.com/kleyson/appz-budget/blob/main/mobile/PRIVACY_POLICY.md
...
- All character counts are within Apple's limits
- Keywords are optimized for App Store search
- Review notes provide comprehensive testing instructions
- Demo credentials are provided for easy review testing
- Privacy and security features are clearly explained
- The app's self-hosted nature is properly documented
